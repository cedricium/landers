...
export default function Contact() {
  return (
    <div className="grid grid-rows-[40px_1fr] items-center justify-items-start min-h-screen overflow-hidden p-8 gap-16 font-[family-name:var(--font-sans)]">
      ...
      <main className="mx-auto max-w-screen-lg w-full h-full flex flex-col gap-12 row-start-2 justify-start items-start">
        ...
        <div className="max-w-[600px] text-white/70 tracking-normal">
          <p>
            Interested in a demo? Want to learn more? Fill out the following
